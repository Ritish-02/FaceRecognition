...
class Face_Recognition:
    def __init__(self,root):
        ...
        img = Image.open(r"college_images\face.jpeg")   
        ...
        img2 = Image.open(r"college_images\face_recognition.jpeg")
        ...
        lbl = Label(bg_img, font=("times new roman", 14, "bold"), bg=bg_img["bg"], fg="black", bd=0, highlightthickness=0)
        lbl.place(x=1400,y=650,width=110,height=50)
        time()

        # def update_time():
        #     """Function to update time in Tkinter UI."""
        #     string = strftime('%H:%M:%S %p')
        #     lbl.config(text=string)
        #     lbl.after(1000, update_time)  # ✅ Use updated function name
